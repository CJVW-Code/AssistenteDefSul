// backend/src/config/varasMapping.js

/**
 * Mapeamento entre o tipo de ação (tipoAcao) e a vara competente.
 * Este arquivo centraliza a lógica para determinar a vara correta,
 * evitando que o usuário precise saber essa informação.
 * 
 * A chave é o nome exato da ação como definido no frontend.
 * O valor é a string da vara que aparecerá no documento.
 */
