...
// O 'useToast' pode ṇo estar configurado. Se der erro, comente as linhas do toast.
      ...
      <form onSubmit={handleConsulta} className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            required
            className="w-full pl-10 pr-4 py-3 .bg-app rounded-lg border .border-soft focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all"
          />
        </div>
        <div className="relative">
          <KeyRound
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full btn-accent   px-6 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 transition-colors"
        >
