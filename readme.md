...
algumas melhorias, para o dados da criança/adolescente, tem que retirar profissão, endereço prissional.

remover valor da causa.

adicionar o rg do representante.

O "Percentual Adicional para Despesas Extras" e "Percentual de Pensão Requerido" remove, no lugar desse campo vai ser um novo campo, valor mensal da pensão e despesas extras. exigir e salvar e formatar em valores Reais.

remover a solicitação de bens a partilhar no caso de fixação alimentos,

remover o Valor para Alimentos Provisórios (se diferente)

lembre do backend tambem,